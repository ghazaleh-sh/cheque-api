...
//        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Cheque");
//        if (hazelCastInstance != null) {
//            log.debug("Hazelcast already initialized");
//            return hazelCastInstance;
//        }
//        Config config = new Config();
//        config.setInstanceName("Cheque");
...
//        MapConfig mapConfig = new MapConfig("ir.co.sadad.cheque.domain.*");
